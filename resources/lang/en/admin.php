...
return [
    'dashboard' => 'Dashboard',
    'dashboard_subtitle' => 'Review, filter, and moderate comments in one place.',
    'comments' => 'Comments',
    ...
    'enabled' => 'Enabled',
    'disabled' => 'Disabled',
    'tag_placeholder' => 'Type a word, then press Enter',
    'tag_empty' => 'Value cannot be empty.',
    'tag_duplicate' => 'This value is already added.',
    'tag_empty_list' => 'No items yet.',
    ...
    'general_help' => 'Core routing, guest access, length limits, and storage.',
    'moderation_help' => 'Queue rules, blacklist, and content censoring.',
    'protection_help' => 'Reports, uploads, NSFW, and reCAPTCHA.',
    'all' => 'All',
    'pending' => 'Pending',
    'approved' => 'Approved',
    'reported' => 'Reported',
    ...
    'delete' => 'Delete',
    'setting' => 'Settings',
    'settings_subtitle' => 'Tune package behavior without touching config files.',
    'settings_footer_hint' => 'Changes apply immediately after save.',
    'save_settings' => 'Save settings',
    'settings_saved' => 'Settings saved successfully.',
    'restore' => 'Restore',
    'search' => 'Search',
    'search_placeholder' => 'Name, email, IP, content, page…',
    'page_id' => 'Page ID',
    'from' => 'From',
    'to' => 'To',
    ...
    'reset_filters' => 'Reset',
    'selected' => 'selected',
    'bulk_confirm' => 'Run this action on the selected comments?',
    'bulk_success' => ':count comment(s) updated.',
    'comment_updated' => 'Comment updated.',
    'comment_deleted' => 'Comment deleted.',
    'comment_restored' => 'Comment restored.',
    'comment_force_deleted' => 'Comment permanently deleted.',
    'nothing_to_update' => 'Nothing to update.',
    'empty_comments' => 'No comments match these filters.',
    'close' => 'Close',
    ...
    'broadcast_label' => 'Broadcast Events',
    'broadcast_description' => 'Enable broadcasting for comment events when configured.',
